defmodule Mix.Tasks.Vkadmin.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix vkadmin.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix vkadmin.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix vkadmin.gen.html Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix vkadmin.gen.html Accounts User users --table cms_users
  ...
  Read the documentation for `vkadmin.gen.schema` for more information on
  attributes.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix vkadmin.gen.html can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/vkadmin.gen.html", binding, files)
