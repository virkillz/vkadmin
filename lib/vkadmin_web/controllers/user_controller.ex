defmodule VkadminWeb.UserController do
  use VkadminWeb, :controller

  alias Vkadmin.Logging
  alias Vkadmin.Account
  alias Vkadmin.Account.User
  alias Vkadmin.Auth.Guardian
  ...
  def login(conn, _params) do
      changeset = Account.change_user(%User{})
      render conn, "login.html", layout: {VkadminWeb.LayoutView, "center.html"}, changeset: changeset
  end
  ...
  case Account.authenticate_user(user, password) do
    ...
    {:error, reason} ->
      ...
      |> render("login.html", layout: {VkadminWeb.LayoutView, "center.html"}, changeset: changeset)
    end
  end
  ...
  def locked(conn, _) do
    ...
    conn
    |> Guardian.logout
    |> render("locked.html", layout: {VkadminWeb.LayoutView, "center.html"}, name: name, avatar: avatar, username: username, changeset: changeset)
  end
